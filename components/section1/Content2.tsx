...
const Content2 = (props: Props) => {
  const CONTENT = [
    { ...CATEGORY_INFO[0], description: <div>ได้แก่ <ul className="list-disc list-inside"><li>สมาชิกราชวงศ์จักรีคนสำคัญ ๆ </li><li>ประธานองคมนตรี</li></ul></div> },
    ...
    { ...CATEGORY_INFO[3], description: <div>ได้แก่ <ul className="list-disc list-inside"><li>พรรคการเมือง</li><li>สมาชิกสภาผู้แทนราษฎร (ส.ส.)</li><li>สมาชิกวุฒิสภา (ส.ว.)</li><li>สมาชิกคณะรัฐมนตรี (ครม.) คนสำคัญ ๆ</li></ul></div> },
  ]
  return (
    ...
    max-w-[957px] mx-auto mb-[140px]'>
      <div className='flex flex-col gap-y-[30px]'>
        ...
        <div className='wv-ibmplex wv-b3 leading-[150%] max-w-[487px] !mx-auto'>ตัวละครการเมืองไทยถูกคัดเลือกจากผู้ที่มีบทบาท/อยู่ในตำแหน่งช่วงรัฐบาลประยุทธ์ จันทร์โอชา 2 และแบ่งตัวละครออกเป็น 4 กลุ่ม</div>
